...
import com.sb2318.netclanclone.view.IndividualAdapter
...
class IndividualFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter= IndividualAdapter(DataService.getPersonData(),requireContext())
        ...
        binding.filterIcon.setOnClickListener {
            ...
            //navigate to individual filter screen
        }
    }
}